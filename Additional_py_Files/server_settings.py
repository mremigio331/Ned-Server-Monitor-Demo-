...
def add_server():
	...
	if save:
		st.info('Add Server disabled in demo mode.')
		#try:
...
def delete_server():
	...
	if delete:
		st.info('Server Delete disabled in demo mode.')
		#try:
...
def edit_server():
	...
	if new_save:
		st.info('Server Edit disabled in demo mode.')
		#if change_ip:
		#	try:
...
def server_status():
	...
	if status:
		st.info('Server Status disabled in demo mode.')
		#try:
